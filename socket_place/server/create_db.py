"""Generate a demo JSON database of tourist places and print their names."""
...
nha_trang = {
    "id": "NHT",
    "name": "Nha Trang",
    "coordinate": (12.24507, 109.19432),
    "description": "Nha Trang là một thành phố ven biển và là trung tâm chính trị, kinh tế, văn hóa, khoa học kỹ thuật và du lịch của tỉnh Khánh Hòa, Việt Nam. Nha Trang được mệnh danh là hòn ngọc của biển Đông, Viên ngọc xanh vì giá trị thiên nhiên, vẻ đẹp cũng như khí hậu của nó.",
    "avatar": "./images/NHT/avt.jpg",
    "images": [
        "./images/NHT/img1.jpg",
        "./images/NHT/img2.jpg",
        "./images/NHT/img3.jpg",
...
vung_tau = {
    "id": "VTA",
    "name": "Vũng Tàu",
    "coordinate": (10.34599, 107.08426),
    "description": "Vũng Tàu là một thành phố thuộc tỉnh Bà Rịa – Vũng Tàu, vùng Đông Nam Bộ, Việt Nam. Sở hữu nhiều bãi biển đẹp và cơ sở hạ tầng được đầu tư hoàn chỉnh, Vũng Tàu là một địa điểm du lịch nổi tiếng tại miền Nam.",
    "avatar": "./images/VTA/avt.jpg",
    "images": [
        "./images/VTA/img1.jpg",
        "./images/VTA/img2.jpg",
        "./images/VTA/img3.jpg",
