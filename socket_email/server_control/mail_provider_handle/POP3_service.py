"""POP3 email polling with a background thread and in-memory queue."""
...
def get_mails():
    """Fetch unread mails, extract sender and subject/body, and enqueue them."""
...
def loop():
    """Continuously poll the POP3 mailbox and enqueue new messages."""
    while True:
        get_mails()
        sleep(RELOAD_TIME)
