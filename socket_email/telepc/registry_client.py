...
class Registry_UI(Canvas):
    def __init__(self, parent, client):
        ...
        self.ex2 = tk.Label(
            self, text="Use only for Get Value / Set Value", anchor="w", bg="#FCD0E8"
        )
        ...
        self.ex3 = tk.Label(
            self, text="Use only for Set Value", anchor="w", bg="#FCD0E8"
        )
