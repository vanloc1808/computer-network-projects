...
Subnet 1: 172.72.0.0/19 dùng cho phòng hành chính, tầng 1 (10 hosts).

Subnet 2: 172.72.32.0/19 dùng cho mạng wi-fi nhân viên và khách vãng lai, tầng 1 (20 hosts).

Subnet 3: 172.72.64.0/19 dùng cho phòng kỹ thuật, tầng 2 (5 hosts).

Subnet 4: 172.72.96.0/19 dùng cho phòng lãnh đạo, tầng 2 (5 hosts).

Subnet 5: 172.72.128.0/19 dùng cho mạng wi-fi phòng họp, tầng 3 (20 hosts).

Tầng 4, 10 servers dùng địa chỉ IP tĩnh, ta lấy tương ứng 10 địa chỉ trong subnet 6: 172.72.160.0/19, cụ thể là 172.72.160.1 - 172.72.160.10
